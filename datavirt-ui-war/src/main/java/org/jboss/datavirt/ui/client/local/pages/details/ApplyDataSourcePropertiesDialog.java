 ...
 */
@Templated("/org/jboss/datavirt/ui/client/local/site/dialogs/apply-datasource-properties-dialog.html#apply-datasource-properties-dialog")
@Dependent
public class ApplyDataSourcePropertiesDialog extends ModalDialog implements HasClickHandlers {

    @Inject @DataField("datasource-name")
    protected InlineLabel dataSourceName;
    @Inject @DataField("apply-datasource-properties-submit-button")
    protected Button submitButton;

    /**
     * Constructor.
     */
    public ApplyDataSourcePropertiesDialog() {
    }
     ...
     * @param event
     */
    @EventHandler("apply-datasource-properties-submit-button")
