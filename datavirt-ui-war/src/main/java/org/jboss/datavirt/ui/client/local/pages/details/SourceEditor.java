...
public class SourceEditor extends Widget implements HasValue<String> {
    ...
    public native void initACE(String id) /*-{
		...
		this.@org.jboss.datavirt.ui.client.local.pages.details.SourceEditor::editor = editor;
    }-*/;
    ...
    public native String getValue() /*-{
        return this.@org.jboss.datavirt.ui.client.local.pages.details.SourceEditor::editor.getValue();
    }-*/;
    ...
    public native void setEditorValue(String value) /*-{
		this.@org.jboss.datavirt.ui.client.local.pages.details.SourceEditor::editor.setValue(value, -1);
    }-*/;
    ...
    protected native void destroyEditor() /*-{
		this.@org.jboss.datavirt.ui.client.local.pages.details.SourceEditor::editor.destroy();
    }-*/;
