...
import org.jboss.datavirt.ui.client.local.animations.FadeOutAnimation;
import org.jboss.datavirt.ui.client.local.animations.MoveAnimation;
import org.jboss.datavirt.ui.client.local.events.MouseInEvent;
import org.jboss.datavirt.ui.client.local.events.MouseOutEvent;
import org.jboss.datavirt.ui.client.local.services.notification.Notification;
import org.jboss.datavirt.ui.client.local.services.notification.NotificationConstants;
import org.jboss.datavirt.ui.client.local.services.notification.NotificationWidget;
import org.jboss.datavirt.ui.client.shared.beans.NotificationBean;
import org.jboss.datavirt.ui.client.shared.beans.NotificationType;
...
public class NotificationService {
     ...
     * @param exception
     */
    public final void sendErrorNotification(String title, String message, DataVirtUiException exception) {
        NotificationBean bean = new NotificationBean();
        bean.setUuid(String.valueOf(notificationCounter++));
     ...
     * @param exception
     */
    public final void sendErrorNotification(String title, DataVirtUiException exception) {
    ...
    public final void sendErrorNotification(String title, Throwable exception) {
        if (exception instanceof DataVirtUiException) {
            sendErrorNotification(title, (DataVirtUiException) exception);
        } else {
     ...
     * @param exception
     */
    public final void completeProgressNotification(String uuid, String title, DataVirtUiException error) {
        NotificationBean bean = new NotificationBean();
        bean.setUuid(uuid);
    ...
    public void completeProgressNotification(String uuid, String title, Throwable error) {
        if (error instanceof DataVirtUiException) {
            completeProgressNotification(uuid, title, (DataVirtUiException) error);
        } else {
            completeProgressNotification(uuid, title, new DataVirtUiException(error));
        }
    }
    ...
    private void createNotificationWidget(final Notification notification) {
        ...
        widget.addMouseInHandler(new org.jboss.datavirt.ui.client.local.events.MouseInEvent.Handler() {
            @Override
        ...
        widget.addMouseOutHandler(new org.jboss.datavirt.ui.client.local.events.MouseOutEvent.Handler() {
            @Override
