 ...
 */
package org.jboss.datavirt.ui.client.local.services.notification;
...
import org.jboss.datavirt.ui.client.local.events.MouseInEvent.HasMouseInHandlers;
import org.jboss.datavirt.ui.client.local.events.MouseOutEvent.HasMouseOutHandlers;
 ...
 */
@Templated("/org/jboss/datavirt/ui/client/local/site/dialogs/growl-dialog.html#growl-dialog")
@Dependent
public class NotificationWidget extends Composite implements HasMouseInHandlers, HasMouseOutHandlers {
    ...
    /**
     * @see org.jboss.datavirt.ui.client.local.events.MouseOutEvent.HasMouseOutHandlers#addMouseOutHandler(org.jboss.datavirt.ui.client.local.events.MouseOutEvent.Handler)
     */
    @Override
    public HandlerRegistration addMouseOutHandler(
            org.jboss.datavirt.ui.client.local.events.MouseOutEvent.Handler handler) {
        return addHandler(handler, MouseOutEvent.getType());
    }

    /**
     * @see org.jboss.datavirt.ui.client.local.events.MouseInEvent.HasMouseInHandlers#addMouseInHandler(org.jboss.datavirt.ui.client.local.events.MouseInEvent.Handler)
     */
    @Override
    public HandlerRegistration addMouseInHandler(
            org.jboss.datavirt.ui.client.local.events.MouseInEvent.Handler handler) {
