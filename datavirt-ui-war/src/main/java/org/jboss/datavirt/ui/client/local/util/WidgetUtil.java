 ...
 */
package org.jboss.datavirt.ui.client.local.util;
...
public final class WidgetUtil {
    ...
    public static native final void addMouseHandlers(final IMouseInOutWidget widget) /*-{
        var element = widget.@org.jboss.datavirt.ui.client.local.util.IMouseInOutWidget::getElement()();
        $wnd.jQuery(element).mouseenter(function() {
            widget.@org.jboss.datavirt.ui.client.local.util.IMouseInOutWidget::onMouseIn()();
        });
        $wnd.jQuery(element).mouseleave(function() {
            widget.@org.jboss.datavirt.ui.client.local.util.IMouseInOutWidget::onMouseOut()();
        });
    }-*/;
