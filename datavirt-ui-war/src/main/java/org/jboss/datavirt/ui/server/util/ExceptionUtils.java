 ...
 */
package org.jboss.datavirt.ui.server.util;
...
public class ExceptionUtils {
	 ...
	 * @param root
	 */
	public static DataVirtUiException createUiException(String message, Throwable root) {
	    DataVirtUiException re = null;
		if (message != null && root != null) {
			re = new DataVirtUiException(message, root);
		} else if (root != null) {
			re = new DataVirtUiException(root);
		} else {
			re = new DataVirtUiException();
		}
...
//			re.setRootStackTrace(getRootStackTrace(root));
	 ...
	 * @param root
	 */
	public static DataVirtUiException createRemoteException(Throwable root) {
